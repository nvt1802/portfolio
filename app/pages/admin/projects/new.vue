...
<template>
  <div>
    ...
    <div class="admin-header" style="margin-bottom: 16px;">
      <div>
        <h1 style="font-size: 28px;">Thêm Dự Án</h1>
        <p style="color: var(--text-secondary); margin-top: 4px;">Thêm dự án mới vào hồ sơ của bạn</p>
      </div>
    </div>

    <!-- Breadcrumbs -->
    <Breadcrumbs :items="[{ name: 'Dự án', to: '/admin/content?tab=projects' }, { name: 'Thêm mới' }]" style="margin-bottom: 24px;" />
